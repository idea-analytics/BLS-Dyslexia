...
print(summary(in_program_current_vs_previous %>% filter(academic_year == '2023-2024')))

print(summary(in_program_current_vs_previous %>% filter(academic_year == '2022-2023')))
...
matchit_data_staar_level <- project_data_full %>%
  filter(!is.na(staar_score_staar_reading),
         !is.na(grade_equivalent_renstar_boy))

matchit_check <- matchit(in_program ~ grade_level_id + sped + is_csi + region_name + 
                    staar_score_staar_reading + grade_equivalent_renstar_boy, 
